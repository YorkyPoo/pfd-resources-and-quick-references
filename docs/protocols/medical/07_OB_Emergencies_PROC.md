...
## Medical - OB Emergencies

This protocol outlines the assessment and management of obstetrical emergencies, including normal childbirth, breech presentations, umbilical cord prolapse, eclampsia (seizures), and third-trimester bleeding such as uterine rupture and abruptio placenta.
...
=== "History of Present Illness"
    ...
    - Presence of vaginal bleeding or fluid discharge
    - Recent trauma or medical complications

=== "Signs & Symptoms"
    - **Labor:** Regular contractions, crowning, urge to push
    - **Pre-eclampsia:** BP > 160/110 mmHg, severe headache, visual disturbances, edema
    - **Third-Trimester Bleeding:** Painless or painful vaginal bleeding
    - **Eclampsia:** Active seizures during pregnancy or postpartum

=== "Differential Considerations"
    - Normal labor vs. false labor
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | Follow Universal Patient Care, don appropriate PPE, and visualize perineum for crowning or presenting part. | | • | | • | |
| 2 | **Normal Delivery:** Apply gentle pressure on infant's skull to prevent explosive delivery. Check for nuchal cord. Dry, warm, and stimulate the neonate. DO NOT perform routine airway suctioning. | | • | | • | |
...
| 6 | **Eclampsia (Seizures):** Administer **[Magnesium Sulfate](Magnesium%20Sulfate.md) 4 g** IV/IO infusion over 10 minutes. | | | | | • |
| 7 | If seizures persist > 5 minutes, administer **[Midazolam](Midazolam.md) 5 mg** IV/IO or **10 mg** IM. | | | | | • |
...
• ⚠ The primary goal of **[Magnesium Sulfate](Magnesium%20Sulfate.md)** administration in eclampsia is to limit and stop seizures, not strictly to lower blood pressure.
