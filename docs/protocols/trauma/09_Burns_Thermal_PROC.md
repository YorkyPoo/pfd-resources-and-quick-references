...
## General - Burns (Thermal, Chemical, Radiation)

### Overview
Guidelines for managing thermal, chemical, and radiation burns, emphasizing airway assessment, TBSA calculation, and destination routing.

### Assessment & Criteria
=== "History of Present Illness"
    - Mechanism of burn (thermal, chemical, radiation)
    - Time of injury
    - Possibility of enclosed space / inhalation injury
    - Exposure to specific chemicals (e.g., Hydrofluoric acid)
    - Associated trauma (e.g., blast, fall, lightning strike)

=== "Signs & Symptoms"
    - Hoarse voice, stridor, carbonaceous sputum (soot in airway)
    - Facial burns or singed facial hair
    - TBSA Estimation: Rule of Palms (1% = patient's palm) or Rule of 9s (Count only 2nd and 3rd-degree burns)
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | Stop the burning process safely and remove the patient from the source. Fully expose the injured area and remove constricting items including clothing. | | • | | • | |
| 2 | Assess airway and respiratory effort. Refer to Airway Management and Ventilatory Support protocol. | | • | | • | |
...
| 6 | Hydrofluoric Acid (HF) Burns with Hypotension: Administer **Calcium Chloride 1 g** IV/IO over 3 mins (Repeat in 5 mins PRN). | | | | | |
...
• ⚠ Pre-hospital hypotension solely due to burns < 20% TBSA is unlikely. Assess patients with hypotension/AMS in the setting of limited burns for concomitant trauma or other medical conditions (e.g., cardiac emergency or cyanide poisoning).
...
• Hydrofluoric Acid (HF) – binds and rapidly reduces serum calcium leading to circulatory collapse. Treat hypotension with **Calcium Chloride 1 g** IV/IO over 3 minutes. Repeat in 5 minutes as needed.
