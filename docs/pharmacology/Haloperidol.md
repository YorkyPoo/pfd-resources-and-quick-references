...
- **Mechanism of Action:** Dopamine antagonist, sedation
...
## Precautions
- Many drug-drug interactions, particularly with medications known to prolong the QT interval
...
- May block the activity of [Epinephrine](Epinephrine.md) – use **[Norepinephrine](Norepinephrine.md)** if vasopressor is required.
...
- ⚠ **Warning:** May block the activity of [Epinephrine](Epinephrine.md) – use **[Norepinephrine](Norepinephrine.md)** if vasopressor is required.
