...
// 2. Infusion Rate (mL / hr) -> Dose (mg/hr) / Ratio (mg/mL)  
const infusionRate = dose / ratio;  
// 3. Manual Rate (gtts / min) -> (Infusion Rate * Drop Factor) / 60  
...
// Round to nearest whole drop for manual rate, as you can't count a fraction of a drop  
